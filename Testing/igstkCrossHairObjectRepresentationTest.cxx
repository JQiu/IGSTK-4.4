/*=========================================================================
  ...
  Module:    $RCSfile: igstkCrossHairObjectRepresentationTest.cxx,v $
  Language:  C++
  Date:      $Date: 2009-06-18 20:35:25 $
...
namespace CrossHairObjectRepresentationTest
{
...
int igstkCrossHairObjectRepresentationTest( int argc, char * argv[] )
{
  if( argc < 3 )
    {
  ...
  typedef CrossHairObjectRepresentationTest::CTImageObserver 
                                                        CTImageObserverType;
  ...
  typedef CrossHairObjectRepresentationTest::VTKImageObserver 
 ...
 typedef igstk::ImageResliceObjectRepresentation< ImageSpatialObjectType >
  ...
  crossHairObjectRepresentation->SetVisibility(true);
