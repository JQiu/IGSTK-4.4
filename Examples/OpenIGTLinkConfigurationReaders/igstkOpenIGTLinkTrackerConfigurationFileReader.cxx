/*=========================================================================
  ...
  Module:    $RCSfile: igstkOpenIGTLinkTrackerConfigurationFileReader.cxx,v $
  Language:  C++
...
OpenIGTLinkTrackerConfigurationFileReader::
  OpenIGTLinkTrackerConfigurationFileReader() : 
  m_StateMachine( this )
{
...
void 
OpenIGTLinkTrackerConfigurationFileReader::RequestSetReader( 
...
void 
OpenIGTLinkTrackerConfigurationFileReader::RequestSetFileName( 
...
void 
OpenIGTLinkTrackerConfigurationFileReader::RequestRead()
{
  igstkLogMacro( DEBUG, "igstk::TrackerConfigurationFileReader::"
                        "RequestRead called...\n" );
...
void 
OpenIGTLinkTrackerConfigurationFileReader::RequestGetData()
{
  igstkLogMacro( DEBUG, "igstk::TrackerConfigurationFileReader::"
...
void 
OpenIGTLinkTrackerConfigurationFileReader::ReportInvalidRequestProcessing()
{
  igstkLogMacro( DEBUG, "igstk::TrackerConfigurationFileReader::"
...
void 
OpenIGTLinkTrackerConfigurationFileReader::SetReaderProcessing()
{
...
void 
OpenIGTLinkTrackerConfigurationFileReader::ReportSetReaderSuccessProcessing()
{
  igstkLogMacro( DEBUG,
...
void 
OpenIGTLinkTrackerConfigurationFileReader::ReportSetReaderFailureProcessing()
{
  igstkLogMacro( DEBUG,
                 "igstk::TrackerConfigurationFileReader::"
...
void 
OpenIGTLinkTrackerConfigurationFileReader::SetFileNameProcessing()
{
...
void 
OpenIGTLinkTrackerConfigurationFileReader::ReportSetFileNameSuccessProcessing()
{
  igstkLogMacro( DEBUG,
                 "igstk::TrackerConfigurationFileReader::"
...
void 
OpenIGTLinkTrackerConfigurationFileReader::ReportSetFileNameFailureProcessing()
{
  igstkLogMacro( DEBUG,
                 "igstk::TrackerConfigurationFileReader::"
...
void 
OpenIGTLinkTrackerConfigurationFileReader::ReadProcessing()
{
  ...
  if(itksys::SystemTools::FileLength( this->m_FileName.c_str() ) == 0 ||
    ...
    try {       //read the xml file
      ...
      if( this->m_XMLFileReader->HaveConfigurationData() )
        {
        this->m_OpenIGTLinkTrackerConfiguration.m_TrackerConfiguration = 
        ...
        OpenIGTLinkTrackerConfigurationXMLFileReader::Pointer oigtLinkXmlReader =
          OpenIGTLinkTrackerConfigurationXMLFileReader::New();
        ...
        if( !oigtLinkXmlReader->HaveConfigurationData() )
          ...
          {
          oigtLinkXmlReader->GetOpenIGTLinkToolConfigurationData( 
            this->m_OpenIGTLinkTrackerConfiguration.m_ToolNamesAndConnections );
          igstkPushInputMacro( Success );
          }
...
void 
OpenIGTLinkTrackerConfigurationFileReader::ReportReadSuccessProcessing()
{
  igstkLogMacro( DEBUG,
                 "igstk::TrackerConfigurationFileReader::"
...
void 
OpenIGTLinkTrackerConfigurationFileReader::ReportReadFailureProcessing()
{
...
void 
OpenIGTLinkTrackerConfigurationFileReader::GetDataProcessing()
{
  OpenIGTLinkConfigurationDataEvent evt;
  evt.Set( &this->m_OpenIGTLinkTrackerConfiguration );
